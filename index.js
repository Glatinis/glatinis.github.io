...
function createMeetingPage(meeting) {
    ...
    document.write(`<h2 id="section">${meeting.section}</h2>`)
    document.write("<hr>")

    document.write("<h2>Code</h2>")
    document.write(`<h2 id="code">${meeting.code}</h2>`)
    document.write("<hr>")

    document.write("<h2>Password</h2>")
    document.write(`<h2 id="password">${meeting.password}</h2>`)
    document.write("<hr>")
